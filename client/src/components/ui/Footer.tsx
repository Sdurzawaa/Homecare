function Footer({
  ...
  return (
    <footer className="w-full bg-[var(--pine-deep,#1c3a30)] px-5 pb-10 pt-20 sm:px-6 md:px-8 lg:px-12">
      <div className="mx-auto max-w-[1280px]">
        <div className="grid grid-cols-1 gap-x-[2.4rem] gap-y-12 md:grid-cols-[1.4fr_1fr_1.2fr]">
          {/* Brand */}
          <div className="flex flex-col gap-5">
            <div className="flex items-center gap-3.5">
              <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-white/10 p-2 ring-1 ring-inset ring-white/15">
                <img
                  src="/Logo.svg"
              ...
              <span className="font-[family-name:var(--font-heading)] text-[1.25rem] font-medium text-white">
                {content?.brand || "Homecare"}
              </span>
            </div>
            <p className="m-0 max-w-sm text-[0.95rem] leading-relaxed text-white/55">
              {content?.description ||
            ...
            <div className="mt-1 flex items-center gap-3.5">
              <a
                ...
                aria-label="WhatsApp"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white/60 transition-colors hover:bg-white/15 hover:text-white"
              >
          ...
          <div className="flex flex-col gap-4">
            <h4 className="m-0 text-[0.9rem] font-semibold uppercase tracking-wide text-white/40">
              Tautan Cepat
            </h4>
        ...
        <div className="mt-14 flex flex-col gap-3 border-t border-white/10 pt-6 sm:flex-row sm:items-center sm:justify-between">
          <p className="m-0 text-[0.85rem] text-white/40">
            © 2024 Homecare. Seluruh hak cipta dilindungi.
          </p>
          <div className="flex gap-6 text-[0.85rem] text-white/40">
